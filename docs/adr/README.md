...
| [0029](0029-adopt-a-compact-non-duplicative-core-constitution.md) | Accepted (amended 2026-09-06) | 2026-07-17 | Rebuild the umbrella as a compact core constitution and route map; amended so the TL;DR also carries a guarded, non-normative one-line glance at every principle file |
