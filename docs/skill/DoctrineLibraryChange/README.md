# DoctrineLibraryChange skill (Claude / compatible runners)

This directory mirrors the same skill for **in-repo** documentation and forks. To install for **Claude Code** (global), copy the folder:
