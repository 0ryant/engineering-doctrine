...
| [evolution/research-full-corpus-council-review-2026-08.md](evolution/research-full-corpus-council-review-2026-08.md) | Full-corpus council review at v0.4.0: 7 area reviews + 3 cross-cutting lenses, adversarial verification (2 blockers, 20 majors confirmed; 31 minors reported); systemic diagnosis — layer drift, two-generation normativity, schema-prose drift, navigation lag; v0.5.0 inputs mapped to forward-plan lanes |
