...
| [evolution/v0.3.0-release-plan.md](evolution/v0.3.0-release-plan.md) | Proposed `v0.3.0` release decisions, task ownership, dependencies, acceptance criteria, and verification gates |
