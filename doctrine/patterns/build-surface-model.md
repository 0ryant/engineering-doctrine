...
For the concise branch-to-production composition, start with [CI/CD Delivery](../impl/cicd-delivery.md); return here for delivery-unit shapes and surface mechanics.
