...
- **Accountability does not transfer to a tool.** Assistance from a model or agent does not make it a **co-owner** or a **co-author** of the resulting artefact: it holds no liability, cannot be on call, and cannot defend the change under incident pressure. Where a change was agent-assisted, a **method record** captures *how it was produced* without diluting the human owner's accountability ([code-review-and-change-approval.md](code-review-and-change-approval.md) §6.1). "The AI wrote it" is not a defence and, equally, is not an accurate account of work an engineer directed, governed, and revised.
- **Second line challenges independently.** Someone **not invested in shipping** — security, privacy, risk, or a peer team where no second-line function exists — reviews high-materiality systems before launch and on material change. Borrow the **effective challenge** test (Fed SR 26-2): the challenger is an objective expert with sufficient independence, organisational standing, and influence to force change. Review that cannot block launch is decoration.
...
- **Transparency to the people the system talks to is a launch gate where the EU AI Act profile applies.** For user-facing GenAI in **EU AI Act** scope (estate registered via [revision-pinned-control-profiles.md](revision-pinned-control-profiles.md)), the **Art 50** transparency families **applicable to the estate's registered role** — provider duties: **AI-interaction disclosure** and **machine-readable marking** of synthetic output; deployer duties: **exposure notification** for emotion-recognition/biometric-categorisation and **deepfake labelling** — are verified **before launch**, with evidence recorded where the inventory points (§1). In force **2026-08-02**. Canonical duties, provider/deployer split, and scope conditions: [../principles/privacy-and-data-governance.md](../principles/privacy-and-data-governance.md) §5.4.
...
| **Agent hijack / tool-flow abuse** | Tier-D agents (tool-calling — [../principles/ai-ml-systems.md](../principles/ai-ml-systems.md) §2) | Distinct from single-turn injection: adversarial redirection of agent **goals and tool calls** through untrusted content (OWASP **ASI01/ASI02**; NIST **AI 100-2e2025** names the **agent hijacking** class). Evaluation is **adaptive (attacker-iterates)**, not static replay — joint US/UK AISI red-teaming moved hijack success **11%→81%** by iterating; the normative evidence bar and tiers live in [../principles/testing-strategy.md](../principles/testing-strategy.md) §5; architecture: [agentic-loop-design.md](agentic-loop-design.md) §9. |
...
| **Transparency / marking** | User-facing GenAI where an **EU AI Act** control profile applies | **Outbound** duty (distinct from the inbound synthetic-media re-test below), **for the estate's registered role**: disclosure UX and output marking (provider) or notification and deepfake labelling (deployer), implemented and **verified pre-launch**, evidence where the inventory points (§1). Canonical duties and role split: [../principles/privacy-and-data-governance.md](../principles/privacy-and-data-governance.md) §5.4. |
...
- **Transparency duties are teachable boundaries.** Where an **EU AI Act** profile is registered for the estate, the acceptable-use artifact SHOULD name which systems carry **Art 50** transparency duties for the estate's role (interaction disclosure, output marking, deepfake labelling — [../principles/privacy-and-data-governance.md](../principles/privacy-and-data-governance.md) §5.4) and who owns the **disclosure UX** and the **marking pipeline** — builders and reviewers cannot honour a duty nobody told them their system carries.
...
| Effective-challenge test imported | Objective expertise, sufficient independence, standing, and influence (SR 26-2) make independence checkable — better than "get a second opinion." |
...
- Federal Reserve **SR 26-2** — Revised Guidance on Model Risk Management (effective challenge; supersedes SR 11-7): https://www.federalreserve.gov/frrs/guidance/supervisory-guidance-on-model-risk-management.htm
...
- **EU AI Act** (Regulation (EU) 2024/1689, canonical: https://eur-lex.europa.eu/eli/reg/2024/1689/oj) — article mirrors: Art 4 (literacy): https://artificialintelligenceact.eu/article/4/ · Art 12 (record-keeping): https://artificialintelligenceact.eu/article/12/ · Art 14 (human oversight): https://artificialintelligenceact.eu/article/14/ · Art 15 (accuracy, robustness): https://artificialintelligenceact.eu/article/15/ · Art 26 (deployer obligations): https://artificialintelligenceact.eu/article/26/ · Art 50 (transparency): https://artificialintelligenceact.eu/article/50/
- **DORA** (Regulation (EU) 2022/2554, canonical: https://eur-lex.europa.eu/eli/reg/2022/2554/oj) — article mirrors: Art 28 (register, exit strategies): https://www.digital-operational-resilience-act.com/Article_28.html · Art 29 (concentration risk): https://www.digital-operational-resilience-act.com/Article_29.html
...
- NIST **AI 100-2e2025** — Adversarial Machine Learning taxonomy (agent hijacking; mitigations evaluated against strong adaptive attacks): https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-2e2025.pdf
- US/UK AISI — **Strengthening AI Agent Hijacking Evaluations** (adaptive, not static; 11%→81%): https://www.nist.gov/news-events/news/2025/01/technical-blog-strengthening-ai-agent-hijacking-evaluations
