# Minimum Viable Doctrine (Team Pitch Template)
...
- **Team / program:**  
- **Primary pain today** (one sentence):   
- **Non-goals for this quarter:**  

---

## Principles We Are Adopting First (5–7)

| # | Principle (short name) | Why it matters *here* | Depth link |
| --- | --- | --- | --- |
| 1 | | | |
| 2 | | | |
| 3 | | | |
...
## Pains → Immediate Actions

| Pain | Smallest next step | Owner | Done when |
| --- | --- | --- | --- |
| | | | |
...
- [ ] This page is **under one screen** for an EM read
- [ ] Every row links to **one** canonical file—no orphan claims
- [ ] Dated or versioned when Presented: **YYYY-MM-DD**
