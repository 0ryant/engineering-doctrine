...
- [patterns/source-authority-and-evidence-grading.md](patterns/source-authority-and-evidence-grading.md) — **source authority and evidence grading**: S1–S7+X source classes × C1–C4 claim support with the independence test, the conformance/empirical split, BCP-14 admission floors, citation metadata (pin/rolling, archiving), and the diagonal-collapse audit — for citation-bearing doctrine estates; this library binds itself
...
- [EVIDENCE-EXCEPTIONS.md](EVIDENCE-EXCEPTIONS.md) — evidence-floor exception register — sub-floor citations admitted as expiring, reusable downref-style exceptions; the evidence-upgrade worklist
...
- [evolution/post-v0.3.0-external-review-decisions-and-v0.4.0-plan-2026-07.md](evolution/post-v0.3.0-external-review-decisions-and-v0.4.0-plan-2026-07.md) — retrospective `v0.3.0` decision register, `v0.3.1` corrections, and forward plan lanes (V40–V48; criteria unmet at the `v0.5.0` cut retargeted to `v0.6.0`)
...
- [evolution/research-ai-native-sdlc-council-designs-2026-07.md](evolution/research-ai-native-sdlc-council-designs-2026-07.md) — session-1 council record: ten-framework landscape map, invariant register, three framed lifecycle designs with adversarial critiques, and decision list feeding the AI-native SDLC line
...
- [evolution/research-full-corpus-council-review-2026-08.md](evolution/research-full-corpus-council-review-2026-08.md) — historical model review at `v0.4.0`; corrected finding counts and current dispositions live in [v0.6.0 readiness](evolution/v060-readiness-2026-09.md)
- [evolution/research-doctrine-integrity-gates-2026-09.md](evolution/research-doctrine-integrity-gates-2026-09.md) — direct link/example checks and canonical-owner readiness routing supporting ADR 0049
- [evolution/research-v060-source-maintenance-2026-09.md](evolution/research-v060-source-maintenance-2026-09.md) — dated source checks and editorial repairs; no automatic control-baseline migration
- [evolution/research-v060-release-and-review-options-2026-09.md](evolution/research-v060-release-and-review-options-2026-09.md) — release identity, withdrawal and semantic-review options with model scenario checks; decisions remain pending
- [evolution/scorecard-four-reader-lenses-2026-09.md](evolution/scorecard-four-reader-lenses-2026-09.md) — the library scored through four reader lenses (engineering manager, CIO, security engineer, non-technical sponsor) with file-cited scores, per-lens verdicts, and a seven-row fix list; model self-review
...
- [evolution/research-agent-loop-graph-cross-check-2026-08.md](evolution/research-agent-loop-graph-cross-check-2026-08.md) — Agent/loop/graph coverage cross-check — corpus verified against a practitioner foil; graphs half-covered (DAG decomposition gap), six-row action list
- [evolution/research-target-state-and-irreversible-decisions-2026-08.md](evolution/research-target-state-and-irreversible-decisions-2026-08.md) — Target-state and irreversible-decisions coverage check — no target operating envelope and no design-time one-way-door inventory (existing irreversibility doctrine is enactment- or asset-scoped); gap register, system-own end-of-life, and design-time legal triggers as the further confirmed gaps; seven-row action list; diligence + council-ratification record
- [evolution/research-source-authority-and-evidence-weighting-2026-08.md](evolution/research-source-authority-and-evidence-weighting-2026-08.md) — Source authority and evidence weighting — census of all 771 external references by class; cross-discipline grading frameworks + standards-body reference mechanics; proposed two-axis scheme (source class × claim support) with BCP-14 admission floors and the additions/promotions/demotions/updates rule set; seven-row action list; council-ratified with the census independently reproduced; **adopted by [ADR 0040](../docs/adr/0040-adopt-source-authority-classes-and-evidence-weighted-citations.md)** — canonical home now [patterns/source-authority-and-evidence-grading.md](patterns/source-authority-and-evidence-grading.md) with the [EVIDENCE-EXCEPTIONS.md](EVIDENCE-EXCEPTIONS.md) register
