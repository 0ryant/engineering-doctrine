...
| Revision-pinned external controls | [patterns/revision-pinned-control-profiles.md](patterns/revision-pinned-control-profiles.md), [patterns/engineering-controls-governance-program.md](patterns/engineering-controls-governance-program.md), [principles/privacy-and-data-governance.md](principles/privacy-and-data-governance.md) | Applicability comes from an explicit authority; exact baseline revision, system/data boundary, parameters/tailoring, assessment method, evidence, exceptions, and migration remain addressable. NIST SP 800-171 is the worked CUI profile, not a universal baseline. |
...
| AI adoption controls | [patterns/ai-adoption-controls.md](patterns/ai-adoption-controls.md), [principles/ai-ml-systems.md](principles/ai-ml-systems.md) §2.1/§3 | Every AI system sits in an owned, materiality-tiered inventory; capability and materiality are orthogonal axes; high-materiality systems get effective challenge, harm-surface tests (fairness, drift, jailbreak, output validation, leakage), provider exit plans, and role-based literacy. |
| Run contracts and verifier packs | [patterns/run-contracts.md](patterns/run-contracts.md), [patterns/verifier-packs.md](patterns/verifier-packs.md) | Every agent run compiles to one typed envelope; required outputs and independently executed verifier packs make missing artefacts and silent stubs fail visibly at the post-run gate. |
| Model routing policy | [../docs/adr/0012-model-routing-policy.md](../docs/adr/0012-model-routing-policy.md), [../contracts/router-policy.v1.schema.json](../contracts/router-policy.v1.schema.json) | The router policy is a provider-neutral v1 contract with a structural 3-tier shape: `tiers: { premium, default, narrow_scope }`, evidence-bound escalation and refusal rules, explicit independent-review requirements, and per-run plus aggregate cost ceilings. Estates bind current model identifiers and thresholds from their own evaluations. |
...
| CUI, NIST SP 800-171, contractual controls, baseline revision migration | [patterns/revision-pinned-control-profiles.md](patterns/revision-pinned-control-profiles.md), [principles/privacy-and-data-governance.md](principles/privacy-and-data-governance.md), [patterns/engineering-controls-governance-program.md](patterns/engineering-controls-governance-program.md) | [checklists/governance-program-readiness.md](checklists/governance-program-readiness.md), [evolution/research-nist-sp-800-171-control-profiles-2026-07.md](evolution/research-nist-sp-800-171-control-profiles-2026-07.md), [docs/adr/0026-adopt-revision-pinned-external-control-profiles.md](../docs/adr/0026-adopt-revision-pinned-external-control-profiles.md) |
...
| AI adoption governance: inventory, materiality, ownership, independent challenge, fairness/drift testing, AI vendor exit, literacy | [patterns/ai-adoption-controls.md](patterns/ai-adoption-controls.md), [principles/ai-ml-systems.md](principles/ai-ml-systems.md) | [checklists/ai-adoption-readiness.md](checklists/ai-adoption-readiness.md), [principles/reliability-slo-incidents.md](principles/reliability-slo-incidents.md) §7, [principles/threat-modeling-stride-lite.md](principles/threat-modeling-stride-lite.md) §3.1, [evolution/research-ai-adoption-control-gaps-2026-07.md](evolution/research-ai-adoption-control-gaps-2026-07.md), [../docs/adr/0023-add-ai-adoption-control-coverage-inventory-challenge-testing-continuity-literacy.md](../docs/adr/0023-add-ai-adoption-control-coverage-inventory-challenge-testing-continuity-literacy.md) |
| AI-native SDLC, objectives, KPIs/KRs, output vs outcome, intervention hypotheses, portfolio decisions, lifecycle authority, evidence-backed transitions, deterministic enactment, runtime reconciliation | [patterns/ai-native-software-development-lifecycle.md](patterns/ai-native-software-development-lifecycle.md), [principles/ai-ml-systems.md](principles/ai-ml-systems.md) §4, [principles/measurement-and-dora.md](principles/measurement-and-dora.md) §2.2 | [checklists/ai-native-sdlc-readiness.md](checklists/ai-native-sdlc-readiness.md), [patterns/run-contracts.md](patterns/run-contracts.md), [patterns/verifier-packs.md](patterns/verifier-packs.md), [principles/merge-path-evidence-and-pipeline-integrity.md](principles/merge-path-evidence-and-pipeline-integrity.md), [evolution/research-ai-native-sdlc-2026-07.md](evolution/research-ai-native-sdlc-2026-07.md), [../docs/adr/0024-adopt-a-doctrine-grounded-ai-native-software-development-lifecycle.md](../docs/adr/0024-adopt-a-doctrine-grounded-ai-native-software-development-lifecycle.md) |
...
| Why is AI-native delivery modelled as evidence-backed state transitions? | [evolution/research-ai-native-sdlc-2026-07.md](evolution/research-ai-native-sdlc-2026-07.md), [docs/adr/0024-adopt-a-doctrine-grounded-ai-native-software-development-lifecycle.md](../docs/adr/0024-adopt-a-doctrine-grounded-ai-native-software-development-lifecycle.md) |
