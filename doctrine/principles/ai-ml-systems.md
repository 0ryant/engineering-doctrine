...
- **Ownership with independent challenge** — a named first-line owner is accountable for purpose, data inputs, acceptable use, and human-oversight mode; high-materiality systems get pre-launch review by an objective expert with sufficient independence and influence to force change (*effective challenge*, SR 26-2 vocabulary): [../patterns/ai-adoption-controls.md](../patterns/ai-adoption-controls.md) §2.
